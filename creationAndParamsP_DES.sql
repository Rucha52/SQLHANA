...
CALL "SYS"."AFLLANG_WRAPPER_PROCEDURE_DROP"('TECH_ANALYSIS', 'P_DES');
DROP TABLE "RESULTS";
DROP TABLE "STATS";
...
CALL "SYS"."AFLLANG_WRAPPER_PROCEDURE_CREATE"('AFLPAL', 'DOUBLESMOOTH', 'TECH_ANALYSIS', 'P_DES', "SIGNATURE");
...
--CALL "P_DES" ("V_DATA", "#PARAMS", "RESULTS", "STATS") WITH OVERVIEW;
